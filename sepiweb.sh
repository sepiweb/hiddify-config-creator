# This script changed by @sepiweb
#!/bin/bash
...
endipresult() {
	...
	"outbounds": [
		...
		"outbounds": [
			"auto",
			"IP->Iran, TelID:@sepiweb",
			"IP->Main, TelID:@sepiweb"
		],
		"default": "auto"
		},
		{
		...
		{
		"type": "wireguard",
		"tag": "IP->Main, TelID:@sepiweb",
		"detour": "IP->Iran, TelID:@sepiweb",
		"local_address": [
			"172.16.0.2/32",
			"'$publicKey2'"
		],
